        ...
        <div class="container">
            ...
            <form method="POST" action="config/recuperacion.php">
                ...
                <div class="form-group">
                    ...
                    <input type="password" autofocus class="form-control" id="password" name="Password" required minlength="8"
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="confir_mPassword" name="Confirm_Password"
